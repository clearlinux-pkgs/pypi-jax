...
Version  : 0.4.20
Release  : 61
URL      : https://files.pythonhosted.org/packages/ed/eb/0d068a8be5c502a9d0ad794a11006a5574922fcb8c9fbe0dbb52bd236894/jax-0.4.20.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/eb/0d068a8be5c502a9d0ad794a11006a5574922fcb8c9fbe0dbb52bd236894/jax-0.4.20.tar.gz
...
%prep
%setup -q -n jax-0.4.20
cd %{_builddir}/jax-0.4.20
pushd ..
cp -a jax-0.4.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699022211
