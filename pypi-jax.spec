...
Version  : 0.4.3
Release  : 44
URL      : https://files.pythonhosted.org/packages/96/f2/cfbefdd74bb04e02c8a0599332c22db9adbdf2b13775de3ce9b0445bdf18/jax-0.4.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/96/f2/cfbefdd74bb04e02c8a0599332c22db9adbdf2b13775de3ce9b0445bdf18/jax-0.4.3.tar.gz
...
%prep
%setup -q -n jax-0.4.3
cd %{_builddir}/jax-0.4.3
pushd ..
cp -a jax-0.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675897255
