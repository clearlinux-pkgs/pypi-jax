...
Version  : 0.4.25
Release  : 67
URL      : https://files.pythonhosted.org/packages/14/45/f7551fed86ec511a4635551687843789e4c6180e958a7d51241266897c57/jax-0.4.25.tar.gz
Source0  : https://files.pythonhosted.org/packages/14/45/f7551fed86ec511a4635551687843789e4c6180e958a7d51241266897c57/jax-0.4.25.tar.gz
...
%prep
%setup -q -n jax-0.4.25
cd %{_builddir}/jax-0.4.25
pushd ..
cp -a jax-0.4.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708992669
