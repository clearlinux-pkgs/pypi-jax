...
Version  : 0.3.18
Release  : 29
URL      : https://files.pythonhosted.org/packages/7a/7f/f15f64d7c25c95c29139c4486cce6f98f78d1cfc7b1bed63fafea195be07/jax-0.3.18.tar.gz
Source0  : https://files.pythonhosted.org/packages/7a/7f/f15f64d7c25c95c29139c4486cce6f98f78d1cfc7b1bed63fafea195be07/jax-0.3.18.tar.gz
...
%prep
%setup -q -n jax-0.3.18
cd %{_builddir}/jax-0.3.18
pushd ..
cp -a jax-0.3.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664231276
