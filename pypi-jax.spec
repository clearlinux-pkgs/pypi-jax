...
Version  : 0.4.0
Release  : 39
URL      : https://files.pythonhosted.org/packages/97/7b/1e931ba96f6882eaa87ac7a802796c3180be5b264f55273918b43ccc516d/jax-0.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/97/7b/1e931ba96f6882eaa87ac7a802796c3180be5b264f55273918b43ccc516d/jax-0.4.0.tar.gz
...
%prep
%setup -q -n jax-0.4.0
cd %{_builddir}/jax-0.4.0
pushd ..
cp -a jax-0.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670891342
