...
Version  : 0.3.10
Release  : 16
URL      : https://files.pythonhosted.org/packages/fd/43/f200bf48839c5286edaa4327c750f888aaec57926051ee966fdd55abd85c/jax-0.3.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/fd/43/f200bf48839c5286edaa4327c750f888aaec57926051ee966fdd55abd85c/jax-0.3.10.tar.gz
...
%prep
%setup -q -n jax-0.3.10
cd %{_builddir}/jax-0.3.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651759437
