...
Version  : 0.4.6
Release  : 47
URL      : https://files.pythonhosted.org/packages/96/76/cb0a6f68915744d3098d09161745f69f33193d83edd18eb1ed3c372fc5e8/jax-0.4.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/96/76/cb0a6f68915744d3098d09161745f69f33193d83edd18eb1ed3c372fc5e8/jax-0.4.6.tar.gz
...
%prep
%setup -q -n jax-0.4.6
cd %{_builddir}/jax-0.4.6
pushd ..
cp -a jax-0.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678466494
