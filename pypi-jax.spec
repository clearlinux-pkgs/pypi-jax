...
Version  : 0.4.4
Release  : 45
URL      : https://files.pythonhosted.org/packages/29/8a/4b43070e1a5951e2c4bece5efb6046f3ef87c427764c6b7ae20159b44bba/jax-0.4.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/29/8a/4b43070e1a5951e2c4bece5efb6046f3ef87c427764c6b7ae20159b44bba/jax-0.4.4.tar.gz
...
%prep
%setup -q -n jax-0.4.4
cd %{_builddir}/jax-0.4.4
pushd ..
cp -a jax-0.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676654242
