...
Version  : 0.3.24
Release  : 37
URL      : https://files.pythonhosted.org/packages/70/4a/1a6beaad79427f9a40d025a1411dfeffe9adce61a958e5ace0dbb9425a19/jax-0.3.24.tar.gz
Source0  : https://files.pythonhosted.org/packages/70/4a/1a6beaad79427f9a40d025a1411dfeffe9adce61a958e5ace0dbb9425a19/jax-0.3.24.tar.gz
...
%prep
%setup -q -n jax-0.3.24
cd %{_builddir}/jax-0.3.24
pushd ..
cp -a jax-0.3.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667843464
