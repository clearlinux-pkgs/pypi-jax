...
Version  : 0.3.14
Release  : 22
URL      : https://files.pythonhosted.org/packages/52/a9/6baa116873b631c48c2e163fa39d47ebe3b00d206df8bd231b8cdd04f000/jax-0.3.14.tar.gz
Source0  : https://files.pythonhosted.org/packages/52/a9/6baa116873b631c48c2e163fa39d47ebe3b00d206df8bd231b8cdd04f000/jax-0.3.14.tar.gz
...
%prep
%setup -q -n jax-0.3.14
cd %{_builddir}/jax-0.3.14
pushd ..
cp -a jax-0.3.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656513427
...
cp %{_builddir}/jax-0.3.14/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jax/2b8b815229aa8a61e483fb4ba0588b8b6c491890
